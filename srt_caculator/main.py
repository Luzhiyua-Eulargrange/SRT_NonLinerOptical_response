...
def main():
    ...
    print("band_k_grid shape:", band_k_grid.shape)
    print("band_energies shape:", band_energies.shape)
    print("band_eigenvectors shape:", band_eigenvectors.shape)
    ...
    rdm_debug_k_grid, _ = make_k_grid(rdm_debug_params)
